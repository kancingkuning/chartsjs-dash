...
function filterData() {
  ...
  const kec_filter = document.getElementById("kec_filter");
   ...
   prov_select = prov_filter.value;
   kab_select = kab_filter.value;
   kec_select = kec_filter.value;
  //  fks_select  = fks_filter.value;
   start_date_select = start_date.value;
   end_date_select = end_date.value;
  ...
  filter_kec_ar2.forEach(function (item) {
   ...
   prov_filter = document.getElementById("prov_filter");
   kab_filter = document.getElementById("kab_filter");
   kec_filter = document.getElementById("kec_filter");
  ...
  filter_kec_ar2.forEach(function (item) {
   ...
   prov_select2 = prov_filter.value;
   kab_select2 = kab_filter.value;
   kec_select2 = kec_filter.value;
