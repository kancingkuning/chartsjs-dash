...
const color_p = await aq.loadCSV(warna_p);
const dt = await aq.loadCSV(file_path);
...
let prov_filter = document.getElementById("prov_filter");
let kab_filter = document.getElementById("kab_filter");
let kec_filter = document.getElementById("kec_filter");
// let fks_filter    = document.getElementById("fks_filter");
...
var ctb = document.getElementById('bar_cdd').getContext('2d');
var bar_cdd = new Chart(ctb, {
    type: 'bar',
    data: cdd_data,
    options: {
        aspectRatio: 2,
